      ...
      <div id="page">
         ...
         <li>
            <a data-code="C901">
               ...
               <strong>C901:</strong> 'call_subprocess' is too complex (23)
               
            </a>
            <ul class="details">
            <li>
               
               <a href="env.lib.python3.9.site-packages.pip._internal.utils.subprocess.source.html#l71">
                  <tt><i>71</i> <span class="k">def</span> <span class="nf">call_subprocess</span><span class="p">(</span></tt>
               </a>
            </li>
            </ul>
         </li>
