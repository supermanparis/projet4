      ...
      <div id="page">
         ...
         <li>
            <a data-code="C901">
               ...
               <strong>C901:</strong> 'ssl_wrap_socket' is too complex (14)
               
            </a>
            <ul class="details">
            <li>
               
               <a href="env.lib.python3.9.site-packages.pip._vendor.urllib3.util.ssl_.source.html#l355">
                  <tt><i>355</i> <span class="k">def</span> <span class="nf">ssl_wrap_socket</span><span class="p">(</span></tt>
               </a>
            </li>
            </ul>
         </li>
