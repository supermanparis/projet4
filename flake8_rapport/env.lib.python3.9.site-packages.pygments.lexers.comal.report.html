...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.9/site-packages/pygments/lexers/comal.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.9.site-packages.pygments.lexers.comal.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env/lib/python3.9/site-packages/pygments/lexers/comal.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.9.site-packages.pygments.lexers.comal.source.html#l37">
                  <tt><i>37</i>     </tt>
               </a>
            </li>
            </ul>
