      ...
      <div id="page">
         ...
         <li>
            <a data-code="C901">
               ...
               <strong>C901:</strong> 'handle_option_line' is too complex (15)
               
            </a>
            <ul class="details">
            <li>
               
               <a href="env.lib.python3.9.site-packages.pip._internal.req.req_file.source.html#l210">
                  <tt><i>210</i> <span class="k">def</span> <span class="nf">handle_option_line</span><span class="p">(</span></tt>
               </a>
            </li>
            </ul>
         </li>
