      ...
      <div id="page">
         ...
         <li>
            <a data-code="C901">
               ...
               <strong>C901:</strong> '_get_index_content' is too complex (13)
               
            </a>
            <ul class="details">
            <li>
               
               <a href="env.lib.python3.9.site-packages.pip._internal.index.collector.source.html#l446">
                  <tt><i>446</i> <span class="k">def</span> <span class="nf">_get_index_content</span><span class="p">(</span></tt>
               </a>
            </li>
            </ul>
         </li>
