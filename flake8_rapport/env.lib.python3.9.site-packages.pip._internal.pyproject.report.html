      ...
      <div id="page">
         ...
         <li>
            <a data-code="C901">
               ...
               <strong>C901:</strong> 'load_pyproject_toml' is too complex (16)
               
            </a>
            <ul class="details">
            <li>
               
               <a href="env.lib.python3.9.site-packages.pip._internal.pyproject.source.html#l29">
                  <tt><i>29</i> <span class="k">def</span> <span class="nf">load_pyproject_toml</span><span class="p">(</span></tt>
               </a>
            </li>
            </ul>
         </li>
